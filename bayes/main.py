...
def plot_feature_distribution(feat_idx, filename):
    plt.figure(figsize=(10, 6))
    name = feature_names[feat_idx]

    for q in all_classes:
        subset = X_train[y_train == q, feat_idx]
        if len(subset) > 0:
...
plot_feature_distribution(10, 'rozklad_alcohol.png')
plot_feature_distribution(1, 'rozklad_volatile_acidity.png')
